...
export default function HomePage() {
	return (
		<>
			...
			<Section
				eyebrow="TAKE CHARGE OF YOUR FUTURE"
				...
				<div className="split-layout">
					<div className="stack">
						...
						<div className="hero-actions">
							<Link
								href={secondaryHero.secondaryCta.href}
			...
			<Section
				...
				intro="Choose how you want to help ALC learners and classrooms in Micronesia."
			>
			...
			<section className="cta-panel section-alt">
				<div className="container reveal-up">
					...
					<p>
						Join programs, partner with us, or support our mission with funds
						and equipment.
					</p>
					<div className="hero-actions">
						<Link href="/programs" className="btn btn-primary">
