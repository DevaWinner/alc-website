export const heroSlides = [
	{
		eyebrow: "Bringing Hope to Micronesia",
		title: "Empowering the Next Generation to Rise Above Poverty",
		summary:
			"Micronesia is geographically isolated and under-resourced, with limited pathways to opportunity. Accelerated Learning Center is a grassroots, community-powered nonprofit helping youth and young adults build practical skills and hope.",
...
export const audiencePaths = [
	...
	},
	{
		...
		summary:
			"Your support directly helps marginalized learners access instruction, equipment, and mentoring in Micronesia.",
		points: [
...
export const homeOutcomes = [
	...
	},
	{
		...
		detail:
			"Daily habits, time management, goal setting, resilience, and motivation are reinforced.",
	},
	{
		metric: "Mentoring",
...
export const donorImpactHighlights = [
	"There are limited instructors in Micronesia with computer-teaching capacity",
	"Laptop funding is needed to expand classroom access to more youth",
	"Consistent donor support is essential expanding our impact in Micronesia",
] as const;
