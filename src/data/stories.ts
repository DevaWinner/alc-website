...
export const stories: Story[] = [
	{
		...
		summary:
			"On December 26, 2025, ALC celebrated graduates from the first Launching Leaders class in Micronesia, focused on growth mindset, time management, values, and a six-step success formula.",
